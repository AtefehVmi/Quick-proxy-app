  ...
  return (
    <div className={cn("w-full", "grid grid-cols-1 xl:grid-cols-24 gap-5")}>
      <div className="xl:col-span-16 px-8 pt-6 pb-8">
        <Heading title="Rotating Mobile" Icon={RotatingResiIcon} />
        <ProxyCard
          image={DatabaseImage}
          features={[
          ...
          title="Rotating Mobile Proxy"
          desc="Bypass toughest targets using trusted ASN provider IPs and  unlimited-duration sessions. ISP (Static Mobile) proxies have 99.9% success rate with most popular targets. Get proxies with exceptional  speed and transparent pricing."
          className="mt-6"
        />
